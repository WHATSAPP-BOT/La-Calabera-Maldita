...
handler.customPrefix = /ok|OK|ok mi amor|ya|Ya|yes|yes|Yess|ven|Ven|si|Si|siii|no|No|nooo|noo|Noo|no demores|No demores|si primo|Si primo|si hijo|Si hijo|Yes|ok|Ok bro|ok primo|ok vale|Ok vale|gracias|Ok|si|gracias amigo|graciass|Gracias bro|gracias bro|Ok|gracias sobrino|gracias sobrina|Gracias sobrino|gracias amigo|Gracias amigo|Gracias mano|gracias mano|ok bro|ok/
