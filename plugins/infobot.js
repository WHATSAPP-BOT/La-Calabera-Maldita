...
╠═〘 *Informacion del Bot* 〙 ═
╠
╠➥ [🤴🏻] Creador del Bot: *La Chica Bot - Calabera Maldita*
╠➥ [#️⃣] Numero del creador: *+1 (336) 271-1679*
...
╠
╠═〘 *La Chica Bot - Calabera Maldita* 〙 ═
`.trim() 
conn.sendMessage(m.chat, info, MessageType.text, { quoted: { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net', fromMe: false }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": '🔥 THE SHADOW BROKERS - BOT 🔥', "jpegThumbnail": fs.readFileSync(`./calabera_bot_editable.jpg`)}}}})
}
